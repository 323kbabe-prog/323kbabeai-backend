// server.js — 323drop Live (AI Favorite Pick + Always Korean Idol + Prefetch Next Image)
// Node >= 20, CommonJS
...
const app = express(); // ✅ must be defined before any app.get()
...
async function generateImageUrl(prompt) {
  try {
    const out = await openai.images.generate({
      model: "gpt-image-1", // faster model
      prompt,
